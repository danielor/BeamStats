...
public class VarianceTest {
  ...
  private static final List<VarianceAccumulator<Number>> VALUES = 
      Arrays.asList(new VarianceAccumulator<>(1, 3.0, 4.0),
  ...
  public void testVariance() throws Exception {
    ArrayList<Number> list = new ArrayList<Number>(Arrays.asList(1, 2, 3, 4, 5));
